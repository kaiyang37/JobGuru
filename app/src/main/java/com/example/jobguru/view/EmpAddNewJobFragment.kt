...
class EmpAddNewJobFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.addJobBtn.setOnClickListener {
            ...
            viewModel.saveJobData(
                ...
                jobMaxSalary,
                onSuccess = {
                    Toast.makeText(requireContext(), "$jobTitle is inserted successfully", Toast.LENGTH_LONG).show()
    ...
    private fun specializationSpinner() {
        ...
        val specializationAdapter =
            ArrayAdapter(requireContext(), android.R.layout.simple_spinner_item, viewModel.specializations)
        specializationAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
        binding.specializationSpinner.adapter = specializationAdapter

        binding.specializationSpinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                parentView: AdapterView<*>,
                selectedItemView: View?,
                position: Int,
    ...
    private fun yearOfExpSpinner() {
        ...
        val yearOfExpAdapter =
            ArrayAdapter(requireContext(), android.R.layout.simple_spinner_item, viewModel.yearsOfExperience)
        ...
        binding.yearOfExpSpinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                parentView: AdapterView<*>,
                selectedItemView: View?,
                position: Int,
